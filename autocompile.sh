...
apt -q update && sudo /usr/bin/apt -qqyy install git wget libssl-dev libxslt-dev libgd-dev libgoogle-perftools-dev libatomic-ops-dev build-essential ccache zip unzip
